pmb_im.services.factory('DrinkService', ['$http', 'ConfigService', function($http, ConfigService) {
  ...
  return {
    ...
    sendDrinkInvitationToUser: function(drink_nid,destination_uid,author_uid,username,password){
      var body = 'user='+username+'&password='+password+'&drink_nid='+drink_nid+'&destination_uid='+destination_uid+'&author_uid='+author_uid+'&hash_id='+Math.random();
    ...
    sendDrinkInvitationResponse: function(response,username,password,invitation_nid,destination_uid){
      var body = 'response='+response+'&user='+username+'&password='+password+'&invitation_nid='+invitation_nid+'&destination_uid='+destination_uid+'&hash_id='+Math.random();
